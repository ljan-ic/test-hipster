...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'omniviewfront';
    ...
    'jhipster.mail.from' = 'omniviewfront@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'omniviewfront API';
    'jhipster.swagger.description' = 'omniviewfront API documentation';
    ...
    'eureka.instance.appname' = 'omniviewfront';
    'eureka.instance.instanceId' = 'omniviewfront:${random.value}';
    ...
    'cloud.config.name' = 'omniviewfront';
